  ...
  resources: {
    ...
    customers: {
      ...
      fields: {
        ...
        city: 'ເມືອງ',
        stateAbbr: 'ແຂວງ',
        orders: 'ການສັ່ງຊື້ຊື້',
        first_name: 'ຊື່',
        first_seen: 'ເບິ່ງຄັ້ງທຳອິດ',
        full_name: 'ນາມສະກຸນ',
        groups: 'ກຸ່ມ',
        has_newsletter: 'ລົງທະບຽນຈຳນວນຂ່າວ',
        has_ordered: 'ໄດ້ສັ່ງຊື້',
        last_name: 'ນາມສະກຸນ',
        last_seen: 'ເບິ່ງຫຼ້າສຸດ',
        last_seen_gte: 'ເບິ່ງຈາກ',
        latest_purchase: 'ການຊື້ຫຼ້າສຸດ',
        name: 'ນາມ',
        total_spent: 'ລາຍຈ່າຍທັງໝົດ',
        zipcode: 'ລະຫັດໄປສະນີ',
        password: 'ລະຫັດຜ່ານ',
    ...
    orders: {
      name: 'ການສັ່ງຊື້ |||| ການສັ່ງຊື້',
      amount: '1 ການສັ່ງຊື້ |||| %{smart_count} ການສັ່ງຊື້',
      title: 'ການສັ່ງຊື້ເລກທີ %{reference}',
      fields: {
        basket: {
          delivery: 'ຄ່າຂົນສົ່ງ',
        ...
        date_gte: 'ອອກຈາກ',
        date_lte: 'ອອກກ່ອນ',
        nb_items: 'ຈຳນວນສິນຄ້າ',
        reference: 'ເລກອ້າງອີງ',
        returned: 'ຖືກຍົກເລີກ',
        status: 'ສະພາບ',
        total_gte: 'ຈຳນວນຂັ້ນຕໍ່າ',
      },
      section: {
        order: 'ການສັ່ງຊື້',
        customer: 'ລູກຄ້າ',
      ...
      notifications: {
        created: 'ການສັ່ງຊື້ຖືກສ້າງ |||| %{smart_count} ການສັ່ງຊື້ຖືກສ້າງ',
        updated: 'ການສັ່ງຊື້ຖືກອັບເດດ |||| %{smart_count} ການສັ່ງຊື້ຖືກອັບເດດ',
        deleted: 'ການສັ່ງຊື້ຖືກລຶບ |||| %{smart_count} ການສັ່ງຊື້ຖືກລຶບ',
      },
    },
    invoices: {
      name: 'ໃບບິນ |||| ໃບບິນ',
      ...
      notifications: {
        created: 'ໃບບິນຖືກສ້າງ |||| %{smart_count} ໃບບິນຖືກສ້າງ',
        updated: 'ໃບບິນຖືກອັບເດດ |||| %{smart_count} ໃບບິນຖືກອັບເດດ',
        deleted: 'ໃບບິນຖືກລຶບ |||| %{smart_count} ໃບບິນຖືກລຶບ',
      },
    },
    products: {
      name: 'ສິນຄ້າ |||| ສິນຄ້າ',
      fields: {
        category_id: 'ປະເພດ',
        height_gte: 'ຄວາມສູງຂັ້ນຕໍ່າ',
        height_lte: 'ຄວາມສູງຂັ້ນສູງ',
        height: 'ຄວາມສູງ',
        image: 'ຮູບພາບ',
        price: 'ລາຄາ',
        reference: 'ເລກອ້າງອີງ',
        ...
        stock: 'ສະຕ໋ອກ',
        thumbnail: 'ພາບຍ່ອຍ',
        width_gte: 'ຄວາມກວ້າງຂັ້ນຕໍ່າ',
        width_lte: 'ຄວາມກວ້າງຂັ້ນສູງ',
        width: 'ຄວາມກວ້າງ',
      },
      tabs: {
        image: 'ຮູບພາບ',
      ...
      filters: {
        ...
        no_stock: 'ຫມົດສະຕ໋ອກ',
        low_stock: '1 - 9 ໜ່ວຍ',
        average_stock: '10 - 49 ໜ່ວຍ',
        enough_stock: '50 ໜ່ວຍຂຶ້ນໄປ',
        sales: 'ການຂາຍ',
        best_sellers: 'ຂາຍດີທີ່ສຸດ',
        average_sellers: 'ຂາຍປົກກະຕິ',
        low_sellers: 'ຂາຍນ້ອຍ',
    ...
    segments: {
      ...
      data: {
        compulsive: 'ຜູ້ຊື້ຢ່າງຫ່ວງວັນ',
        collector: 'ຜູ້ສະຫນອງ',
        ordered_once: 'ສັ່ງຊື້ແລ້ວ',
        regular: 'ປົກກະຕິ',
        returns: 'ຄືນສິນຄ້າ',
        reviewer: 'ຜູ້ຄໍາຕິຊົມ',
      },
    },
  },
};
